...
class SiteVisitFormScreen extends StatefulWidget {
  ...
  @override
  State<SiteVisitFormScreen> createState() =>
      _SiteVisitFormScreenState();
}

class _SiteVisitFormScreenState
    extends State<SiteVisitFormScreen> {

  bool loading = true;

  String? reportId;

  final estimatedBudgetController =
      TextEditingController();

  final totalCostController =
      TextEditingController();

  final usableAreaController =
      TextEditingController();

  final roomsController =
      TextEditingController();

  final siteAreaController =
      TextEditingController();
